...
function HorizontalBar({
  ...
  return (
    <div ref={ref} className="space-y-2">
      ...
      <div className="w-full h-3 bg-gardenia rounded-full overflow-hidden">
        <motion.div
      ...
      {sublabel && (
        <p className="text-xs text-charcoal/50">{sublabel}</p>
      )}
    </div>
  );
}
...
export default function DataVizPage() {
  return (
    <div className="min-h-screen bg-floral-white text-charcoal font-work-sans">
      ...
      {/* ───────────── PROBLEM - Ring Charts + Stat Cards ───────────── */}
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Ring Charts for Gap Stats */}
          <div className="mt-16">
            <ScrollReveal direction="up">
              <h3 className="font-lora italic font-semibold text-2xl sm:text-3xl text-marine-green tracking-[-0.02em] mb-10 text-center">
                The confidence gap your employees face
              </h3>
            </ScrollReveal>
            <div className="flex flex-wrap justify-center gap-12 sm:gap-16">
              <ProgressRing
                percentage={95}
                color="#EA6430"
                label="of carer employees say care negatively impacts their wellbeing"
                size={140}
              />
              <ProgressRing
                percentage={78}
                color="#00433D"
                label="don't feel confident navigating care costs"
                size={140}
              />
              <ProgressRing
                percentage={76}
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28">
        <div className="max-w-6xl mx-auto">
          ...
          <ScrollReveal direction="up" delay={0.15}>
            <div className="mt-10 bg-coral/5 border-l-4 border-coral rounded-r-2xl p-8">
              <h3 className="font-lora italic font-semibold text-xl sm:text-2xl text-charcoal leading-snug tracking-[-0.02em]">
                {gapInsight.headline}
              </h3>
              <p className="mt-3 text-charcoal/70 leading-relaxed max-w-2xl">
                {gapInsight.body}
              </p>
            </div>
          </ScrollReveal>
              ...
              return (
                <ScrollReveal key={i} direction="up" delay={i * 0.1}>
                  <HorizontalBar
                    percentage={pct}
                    label={stat.label}
                    color={i === 0 ? "bg-marine-green" : i === 1 ? "bg-coral" : "bg-warm-orange"}
                    delay={0.2}
                  />
                </ScrollReveal>
              );
            ...
            {services.map((service, i) => (
              <ScrollReveal key={i} direction="up" delay={i * 0.08}>
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-7 hover:bg-white/10 transition-colors h-full">
                  <div className="w-11 h-11 rounded-xl bg-coral/20 text-coral flex items-center justify-center mb-5">
                    <ChallengeIcon icon={service.icon} />
                  </div>
                  <h3 className="font-lora italic font-semibold text-lg text-white mb-2 tracking-[-0.02em]">
                    {service.title}
                  </h3>
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28">
        <div className="max-w-6xl mx-auto">
          ...
          {/* BA Challenge Stats - Dashboard Grid */}
          <div className="mt-14">
            <ScrollReveal direction="up">
          ...
          {/* BA Result Stats - Dashboard with animated CountUp */}
          <div className="mt-14">
            <ScrollReveal direction="up">
              <h3 className="font-lora italic font-semibold text-2xl text-charcoal tracking-[-0.02em] mb-6">
                The results
          ...
          {/* Diversity Stats - Horizontal Bars */}
          <div className="mt-14">
            <ScrollReveal direction="up">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {diversityStats.map((stat, i) => {
                const pct = parseFloat(stat.value.replace(/[^0-9.]/g, ""));
                const isValidPct = !isNaN(pct) && pct <= 100;
                return (
                  <ScrollReveal key={i} direction="up" delay={i * 0.1}>
                    <div className="bg-sunflower/20 border border-sunflower/40 rounded-2xl p-6">
                      {isValidPct ? (
                        <ProgressRing
                          percentage={pct}
                          color="#00433D"
                        ...
                        <div className="text-center">
                          <p className="font-work-sans font-bold text-4xl tabular-nums text-marine-green">
                            {stat.value}
                          </p>
                          <p className="text-sm text-charcoal/70 mt-3 leading-snug">
                            {stat.label}
                          </p>
                        </div>
                      )}
          ...
          {/* TFL Projections - Big dashboard cards */}
          <div className="mt-14">
            {tflProjection.label && (
              <ScrollReveal direction="up">
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28 bg-floral-white">
        <div className="max-w-6xl mx-auto">
          <ScrollReveal direction="up">
            <p className="text-sm uppercase tracking-[0.2em] text-coral font-semibold mb-3">
              Executive Perspective
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28 bg-gardenia">
        <div className="max-w-4xl mx-auto">
          <ScrollReveal direction="up">
            <h2 className="font-lora italic font-semibold text-4xl sm:text-5xl text-marine-green leading-tight tracking-[-0.02em] text-center">
          ...
          <div className="mt-14 space-y-8">
            {testimonials.map((testimonial, i) => (
              <ScrollReveal key={i} direction="up" delay={i * 0.15}>
                <div className="bg-white rounded-2xl p-8 sm:p-10 shadow-sm border border-gardenia">
                  <svg className="w-8 h-8 text-coral/30 mb-4" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10H14.017zM0 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151C7.546 6.068 5.983 8.789 5.983 11h4v10H0z" />
                  </svg>
                  <blockquote className="text-lg text-charcoal/80 leading-relaxed">
      ...
      <section className="px-6 sm:px-12 lg:px-20 py-20 sm:py-28 bg-coral/5">
        <div className="max-w-4xl mx-auto text-center">
          ...
          {/* TFL Projection stats as a "calculator" row */}
          <ScrollReveal direction="up" delay={0.2}>
            <div className="mt-10 grid grid-cols-3 gap-4 max-w-2xl mx-auto">
              {tflProjectionStats.map((stat, i) => (
                <div key={i} className="bg-white rounded-xl p-4 shadow-sm border border-gardenia">
                  <p className="font-work-sans font-bold text-xl sm:text-2xl tabular-nums text-coral">
                    {stat.value}
                  </p>
